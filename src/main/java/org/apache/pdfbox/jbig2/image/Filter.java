...
abstract class Filter
{
    ...
    public static final class Bessel extends Filter
    {
        ...
        private double J1(final double x)
        {
            ...
            final double[] Qone = { 0.11623987080032122878585294e+22, 0.1185770712190320999837113348e+20,
        ...
        private double P1(final double x)
        {
            ...
            final double[] Qone = { 0.352246649133679798068390431e+5, 0.626943469593560511888833731e+5,
        ...
        private double Q1(final double x)
        {
            ...
            final double[] Qone = { 0.74917374171809127714519505e+4, 0.154141773392650970499848051e+5,
